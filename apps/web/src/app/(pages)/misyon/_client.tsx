...
import { Sparkles, Users, Shield, Bot, ArrowRight } from "lucide-react";
    ...
    <div className="relative min-h-screen bg-background text-foreground">
      ...
      <section className="relative overflow-hidden">
        <div className="relative flex flex-col items-center justify-center py-16 md:py-24 px-6 text-center">
          ...
          <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="text-4xl md:text-5xl font-extrabold tracking-tight text-white mb-3">
            KARGANOT’un Misyonu
          </motion.h1>
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.05 }} className="text-base md:text-lg text-white/90 max-w-3xl">
            Eğitimde adalet, paylaşımda kazanç — bilgi paylaştıkça çoğalır.
          </motion.p>
          <div className="mt-6 flex items-center gap-3">
            <Link href="/urun" aria-label="KARGANOT’u keşfet">
              <Button size="lg" className="rounded-full btn-premium">Keşfet</Button>
            </Link>
            <Link href="/kayit" aria-label="Hemen Başla">
              <Button size="lg" variant="outline" className="rounded-full btn-ghost-premium">Hemen Başla</Button>
            </Link>
          </div>
        </div>
      </section>
      ...
      <div className="container mx-auto max-w-6xl px-6 py-16 md:py-20 space-y-16">
        ...
        <section aria-labelledby="amac-heading" className="grid md:grid-cols-2 gap-8 md:gap-10">
          <motion.div {...fadeUp}>
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
              KARGANOT, her öğrencinin potansiyeline erişebilmesi için kurulmuş bir platformdur. Bilgiyi paylaşmak, sadece bireysel bir fayda değil; aynı zamanda kolektif bir ilerlemedir.
            </p>
          </motion.div>
          ...
          <div className="relative">
            ...
            <div className="grid md:grid-cols-3 gap-6 relative">
              {[
                ...
                <motion.div key={t.year} initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: i * 0.1 }} className="text-center">
        ...
        <section aria-labelledby="birlikte-heading" className="text-center">
          <motion.div {...fadeUp}>
            ...
            <blockquote className="italic text-xl md:text-2xl max-w-3xl mx-auto text-muted-foreground">
              “Bir öğrencinin başarısı, binlercesine ilham olabilir. Biz, o ilhamın taşıyıcısıyız.”
            </blockquote>
